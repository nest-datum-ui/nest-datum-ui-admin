...
const jobOptionRelationList = {
	title: 'jobs',
	subtitle: 'List of countries that own the current setting.',
	formName: 'jobsJobOptionRelationForm',

	id: 'jobs-job-option-relations-list',
	storeName: 'jobs-job-option-relations-list',
	columnName: 'jobId',
	apiMainModelUrl: `${process.env.URL_API_JOBS}/job`,
	apiUrl: 'job/option',
	initialPage: 1,
	initialLimit: 9999,
...
export default jobOptionRelationList;
