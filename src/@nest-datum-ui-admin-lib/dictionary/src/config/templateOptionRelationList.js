...
const templateOptionRelationList = {
	title: 'Templates',
	subtitle: 'List of templates that own the current setting.',
	formName: 'dictionaryTemplateOptionRelationForm',

	id: 'dictionary-template-option-relations-list',
	storeName: 'dictionary-template-option-relations-list',
	columnName: 'templateId',
	apiMainModelUrl: `${process.env.URL_API_DICTIONARY}/template`,
...
export default templateOptionRelationList;
