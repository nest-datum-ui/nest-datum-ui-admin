...
const contentStatusList = {
	parentName: 'dictionaryContentStatus',
	
	id: 'dictionary-content-statuses-list',
	storeName: 'dictionary-content-statuses-list',
...
export default contentStatusList;
