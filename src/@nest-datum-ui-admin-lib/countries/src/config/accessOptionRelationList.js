...
const accessOptionRelationList = {
	...
	formName: 'countriesAccessOptionRelationForm',

	id: 'countries-accesses-option-relations-list',
	storeName: 'countries-accesses-option-relations-list',
	columnName: 'accessId',
	apiMainModelUrl: `${process.env.URL_API_COUNTRIES}/access`,
