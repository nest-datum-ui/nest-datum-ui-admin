...
const accessOptionRelationList = {
	...
	formName: 'httpAccessOptionRelationForm',

	id: 'http-accesses-option-relations-list',
	storeName: 'http-accesses-option-relations-list',
	columnName: 'accessId',
	apiMainModelUrl: `${process.env.URL_API_HTTP}/access`,
