...
const accessOptionRelationList = {
	...
	formName: 'mailAccessOptionRelationForm',

	id: 'mail-accesses-option-relations-list',
	storeName: 'mail-accesses-option-relations-list',
	columnName: 'accessId',
	apiMainModelUrl: `${process.env.URL_API_MAIL}/access`,
